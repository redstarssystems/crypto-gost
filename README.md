...
- **Способ 2.** Скачайте артефакты
  ...
  и установите нужные модули. Пример установки для модуля
  `crypto-gost-core`:  

      mvn install:install-file \
        -Dfile=crypto-gost-core-0.3.4.jar \
        -Dsources=crypto-gost-core-0.3.4-sources.jar \
        -Djavadoc=crypto-gost-core-0.3.4-javadoc.jar \
        -DgroupId=org.rssys \
...
Проверить подпись можно так:
    ...
    gpg --import KEYS
    gpg --verify crypto-gost-core-0.3.4.jar.asc crypto-gost-core-0.3.4.jar
...
- Безопасность, даже для личных проектов, очень важна. Авторы
  ...
  недостатки в них. В качестве примера приведу
  [CVE-2025-14813](https://www.cve.org/CVERecord?id=CVE-2025-14813) для
  режиме шифрования CTR. Атакующий может восстановить открытый текст без
