...
- **Способ 2.** Скачайте артефакты
  ...
  установки:  
      ...
      mvn install:install-file \
        -Dfile=crypto-gost-core-0.3.3.jar \
        -Dsources=crypto-gost-core-0.3.3-sources.jar \
        -Djavadoc=crypto-gost-core-0.3.3-javadoc.jar \
        -DgroupId=org.rssys \
...
Проверить подпись можно так:
    ...
    gpg --import KEYS
    gpg --verify crypto-gost-core-0.3.3.jar.asc crypto-gost-core-0.3.3.jar
...
- [Стресс-тестирование
  JSSE-модуля](crypto-gost-jsse/doc/stress-test-03.md)
...
- Безопасность, даже для личных проектов, очень важна. Авторы
  ...
  [CVE-2025-14813](https://nvd.nist.gov/vuln/detail/CVE-2025-14813) для
...
С учетом
[CVE-2025-14813](https://nvd.nist.gov/vuln/detail/CVE-2025-14813) и
