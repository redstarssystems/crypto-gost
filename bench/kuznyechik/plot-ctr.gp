...
set output 'results/kuznyechik-ctr-throughput.png'

set title 'Kuznyechik CTR Mode — Throughput'
...
plot 'results/_data-ctr.tsv' using 2:3:xtic(1) title 'crypto-gost' lt rgb '#2c7bb6', \
