...
set output 'results/ecgost256-throughput.png'

set title 'ECGOST-256 Signature Throughput (CryptoPro-A)'
...
plot 'results/_data.tsv' using 2:3:xtic(1) title 'crypto-gost' lt rgb '#2c7bb6', \
