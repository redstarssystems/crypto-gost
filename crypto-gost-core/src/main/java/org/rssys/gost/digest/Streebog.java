...
public abstract class Streebog implements Digest {
     ...
     * через вложенный цикл 8×8. Внутренний цикл по j образует линейную
     * комбинацию по столбцу i: V[56 - 8*j + i].
     * Явный unroll 8×8 — избыточен, C2 разворачивает тривиально.
     */
    private void F(byte[] V) {
        for (int i = 0; i < 8; i++) {
            long r = 0;
            for (int j = 0; j < 8; j++) {
                r ^= T[j][V[56 - 8 * j + i] & 0xFF];
            }
            F_res[i] = r;
        }

        long r = F_res[0];
        V[7] = (byte)(r >> 56); V[6] = (byte)(r >> 48); V[5] = (byte)(r >> 40); V[4] = (byte)(r >> 32);
        V[3] = (byte)(r >> 24); V[2] = (byte)(r >> 16); V[1] = (byte)(r >>  8); V[0] = (byte)(r);

        r = F_res[1];
        V[15] = (byte)(r >> 56); V[14] = (byte)(r >> 48); V[13] = (byte)(r >> 40); V[12] = (byte)(r >> 32);
        V[11] = (byte)(r >> 24); V[10] = (byte)(r >> 16); V[9]  = (byte)(r >>  8); V[8]  = (byte)(r);

        r = F_res[2];
        V[23] = (byte)(r >> 56); V[22] = (byte)(r >> 48); V[21] = (byte)(r >> 40); V[20] = (byte)(r >> 32);
        V[19] = (byte)(r >> 24); V[18] = (byte)(r >> 16); V[17] = (byte)(r >>  8); V[16] = (byte)(r);

        r = F_res[3];
        V[31] = (byte)(r >> 56); V[30] = (byte)(r >> 48); V[29] = (byte)(r >> 40); V[28] = (byte)(r >> 32);
        V[27] = (byte)(r >> 24); V[26] = (byte)(r >> 16); V[25] = (byte)(r >>  8); V[24] = (byte)(r);

        r = F_res[4];
        V[39] = (byte)(r >> 56); V[38] = (byte)(r >> 48); V[37] = (byte)(r >> 40); V[36] = (byte)(r >> 32);
        V[35] = (byte)(r >> 24); V[34] = (byte)(r >> 16); V[33] = (byte)(r >>  8); V[32] = (byte)(r);

        r = F_res[5];
        V[47] = (byte)(r >> 56); V[46] = (byte)(r >> 48); V[45] = (byte)(r >> 40); V[44] = (byte)(r >> 32);
        V[43] = (byte)(r >> 24); V[42] = (byte)(r >> 16); V[41] = (byte)(r >>  8); V[40] = (byte)(r);

        r = F_res[6];
        V[55] = (byte)(r >> 56); V[54] = (byte)(r >> 48); V[53] = (byte)(r >> 40); V[52] = (byte)(r >> 32);
        V[51] = (byte)(r >> 24); V[50] = (byte)(r >> 16); V[49] = (byte)(r >>  8); V[48] = (byte)(r);

        r = F_res[7];
        V[63] = (byte)(r >> 56); V[62] = (byte)(r >> 48); V[61] = (byte)(r >> 40); V[60] = (byte)(r >> 32);
        V[59] = (byte)(r >> 24); V[58] = (byte)(r >> 16); V[57] = (byte)(r >>  8); V[56] = (byte)(r);
    }
