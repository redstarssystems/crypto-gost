...
class SCryptTest {
    ...
    void testVector1() throws Exception {
        ...
        assertArrayEquals(expected, actual,
            "RFC 7914 вектор 1: scrypt(\"\", \"\", 16, 1, 1, 64) не совпал");
    }
    ...
    @Test
    @DisplayName("RFC 7914 §12 вектор 2: scrypt(\"password\", \"NaCl\", N=1024, r=8, p=16, dkLen=64)")
    ...
    @Test
    @DisplayName("RFC 7914 §12 вектор 3: scrypt(\"pleaseletmein\", \"SodiumChloride\", N=16384, r=8, p=1, dkLen=64)")
    ...
    void testPasswordSensitivity() throws Exception {
        ...
        assertFalse(Arrays.equals(dk1, dk2),
            "Разные пароли должны давать разные производные ключи");
    }
    ...
    void testSaltSensitivity() throws Exception {
        ...
        assertFalse(Arrays.equals(dk1, dk2),
            "Разные соли должны давать разные производные ключи");
    }
    ...
    void testOutputLength() throws Exception {
        ...
        for (int dkLen : new int[]{1, 16, 32, 64, 100}) {
            ...
            assertEquals(dkLen, dk.length,
                "Длина вывода должна быть равна dkLen=" + dkLen);
        }
    }
