...
class SignatureTest {
  ...
  void testRoundtrip256() {
    roundtrip(ECParameters.tc26a256(), Streebog256::new,
  ...
  void testRoundtrip512() {
    roundtrip(ECParameters.tc26a512(), Streebog512::new,
  ...
  private void roundtrip(ECParameters params, Supplier<Digest> digestFactory, String privKeyHex) {
    ...
    BigInteger wrongD = d.add(BigInteger.ONE).mod(params.n.subtract(BigInteger.ONE)).add(BigInteger.ONE);
  ...
  void testDigestSigner256() {
    digestRoundtrip(ECParameters.tc26a256(), Streebog256::new,
      "0A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8C9D0E1F");
  }
  ...
  void testDigestSigner512() {
    digestRoundtrip(ECParameters.tc26a512(), Streebog512::new,
      "1C5B9A9D9C5B7AD29A2D74A4D4A3B9E4D5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8");
  }

  private void digestRoundtrip(ECParameters params, Supplier<Digest> digestFactory, String privKeyHex) {
    BigInteger d = new BigInteger(privKeyHex, 16);
    ECPoint g = ECPoint.affine(params.gx, params.gy, params);
    ECPoint Q = g.multiply(d);
  ...
  void testBasePointOnCurve() {
    ...
    for (ECParameters p : curves) {
      ...
      assertTrue(g.isOnCurve(), "base point on curve: " + p.p.toString(16).substring(0, 8) + "...");
      assertTrue(g.multiply(p.n).isInfinity(), "n*G = infinity: " + p.p.toString(16).substring(0, 8) + "...");
    }
  }
  ...
  void testRoundtripTc26b512() {
    roundtrip(ECParameters.tc26b512(), Streebog512::new,
      "1C5B9A9D9C5B7AD29A2D74A4D4A3B9E4D5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8");
  }
  ...
  void testRoundtripTc26c512() {
    roundtrip(ECParameters.tc26c512(), Streebog512::new,
  ...
  void testRoundtripCryptoProA() {
    roundtrip(ECParameters.cryptoProA(), Streebog256::new,
      "0A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8C9D0E1F");
  }
  ...
  void testRoundtripCryptoProB() {
    roundtrip(ECParameters.cryptoProB(), Streebog256::new,
  ...
  void testRoundtripCryptoProC() {
    roundtrip(ECParameters.cryptoProC(), Streebog256::new,
  ...
  void testSignatureLength256() {
    ...
    BigInteger d = new BigInteger("0A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8090A1B2C3D4E5F6A7B8C9D0E1F", 16);
  ...
  void testRfc7091PublicKeyDerivation() {
    ...
    BigInteger expectedQx = new BigInteger(
      "7F2B49E270DB6D90D8595BEC458B50C58585BA1D4E9B788F6689DBD8E56FD80B", 16);
    BigInteger expectedQy = new BigInteger(
  ...
  void testRfc7091KTimesG() {
    ...
    BigInteger expectedR = new BigInteger(
      "41AA28D2F1AB148280CD9ED56FEDA41974053554A42767B83AD043FD39DC0493", 16);

    ECPoint g = ECPoint.affine(params.gx, params.gy, params);
    ECPoint C = g.multiply(k).normalize();

    assertEquals(expectedR, C.getX().mod(params.n),
      "RFC 7091 x_C mod q must equal r");
  }
  ...
  void testRfc7091SignatureFormula() {
    ...
    BigInteger r = new BigInteger(
      "41AA28D2F1AB148280CD9ED56FEDA41974053554A42767B83AD043FD39DC0493", 16);
    BigInteger expectedS = new BigInteger(
  ...
  void testRfc7091Verification() {
    ...
    BigInteger expectedZ1 = new BigInteger(
      "5358F8FFB38F7C09ABC782A2DF2A3927DA4077D07205F763682F3A76C9019B4F", 16);
    BigInteger expectedZ2 = new BigInteger(
  ...
  void testRfc7091FullVerify() {
    ...
    BigInteger eVal = new BigInteger(
      "2DFBC1B372D89A1188C09C52E0EEC61FCE52032AB1022E8E67ECE6672B043EE5", 16);
    BigInteger r = new BigInteger(
      "41AA28D2F1AB148280CD9ED56FEDA41974053554A42767B83AD043FD39DC0493", 16);
    BigInteger s = new BigInteger(
    ...
    byte[] hash   = reverseBytes(eBytes);   // ECDSASigner сделает reverseBytes внутри → вернёт eBytes

    ECDSASigner signer = new ECDSASigner(Streebog256::new);
    signer.init(false, new PublicKeyParameters(Q, params));

    assertTrue(signer.verifySignature(hash, r, s),
  ...
  void testRfc6979KDeterminism_Rfc7091Curve() {
    ...
    // raw hash = reverseBytes(e) — big-endian вывод Streebog, как передаётся в generateSignature.
    BigInteger eVal = new BigInteger(
      "2DFBC1B372D89A1188C09C52E0EEC61FCE52032AB1022E8E67ECE6672B043EE5", 16);
  ...
  void testRfc6979KDeterminism_CryptoProA() {
    ...
    assertArrayEquals(
      toFixedBytes(new BigInteger(
        "12a50838191b5504f1e5f2fd078714cf6b592b9d29af99d0b10d8d02881c3857", 16), 32),
      hash,
