...
class CmacApiTest {
    ...
    void testCmacTagBytesZero() {
        assertThrows(IllegalArgumentException.class, () -> CmacApi.cmac(MSG, KEY, 0));
    }

    @Test
    @DisplayName("cmac: tagBytes > 16 -> IllegalArgumentException")
    void testCmacTagBytesTooLarge() {
        assertThrows(IllegalArgumentException.class, () -> CmacApi.cmac(MSG, KEY, 17));
    }

    @Test
    @DisplayName("cmac: tagBytes отрицательный -> IllegalArgumentException")
    void testCmacTagBytesNegative() {
        assertThrows(IllegalArgumentException.class, () -> CmacApi.cmac(MSG, KEY, -1));
    }
