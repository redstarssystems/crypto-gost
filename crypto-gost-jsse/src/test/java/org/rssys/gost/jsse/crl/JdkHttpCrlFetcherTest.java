 ...
 */
@DisplayName("JdkHttpCrlFetcher: HTTP CRL fetcher")
class JdkHttpCrlFetcherTest {

    private static final byte[] SENTINEL = "CRL_RESPONSE_OK".getBytes(java.nio.charset.StandardCharsets.UTF_8);
    ...
    void testFetchSuccess() throws Exception {
        ...
        JdkHttpCrlFetcher fetcher = new JdkHttpCrlFetcher(Duration.ofSeconds(5), 5 * 1024 * 1024, true);
    ...
    void testFetchTimeout() {
        ...
        assertThrows(java.io.IOException.class,
                () -> fetcher.fetch("http://192.0.2.1:9999/crl.crl"));
    }
}
