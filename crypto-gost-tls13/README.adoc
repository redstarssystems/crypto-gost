...
Модуль `crypto-gost-tls13` реализует защищённый протокол TLS 1.3 с ГОСТ-профилем
(RFC 9367).
...
- xref:doc/architecture.adoc[Архитектура модуля] — описание слоёв, ключевых классов, handshake flow, threading model, ограничений.
