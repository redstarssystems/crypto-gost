...
public final class GostOids {
    ...
    // ========================================================================
    // ГОСТ EKU для квалифицированных/неквалифицированных подписей (PKI ГОСТ)
    // ========================================================================

    /** 1.2.643.100.113.1 — УКЭП (усиленная квалифицированная электронная подпись) */
    public static final String EKU_UKEP = "1.2.643.100.113.1";
    /** 1.2.643.100.113.2 — УНЭП (усиленная неквалифицированная электронная подпись) */
    public static final String EKU_UNEP = "1.2.643.100.113.2";
