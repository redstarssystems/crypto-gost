...
class TlsTreeTest {
    ...
    void testDeriveKeyLengthL() {
        byte[] key = TlsTree.deriveKey(ZERO_KEY, 0, csL().getC1(), csL().getC2(), csL().getC3(), csL().getKeyLen());
    ...
    void testDeriveKeyDeterminism() {
        ...
        byte[] k1 = TlsTree.deriveKey(ZERO_KEY, 42, cs.getC1(), cs.getC2(), cs.getC3(), cs.getKeyLen());
        byte[] k2 = TlsTree.deriveKey(ZERO_KEY, 42, cs.getC1(), cs.getC2(), cs.getC3(), cs.getKeyLen());
    ...
    void testDeriveKeyDifferentSeqNum() {
        ...
        byte[] k0 = TlsTree.deriveKey(ZERO_KEY, 0L, cs.getC1(), cs.getC2(), cs.getC3(), cs.getKeyLen());
        byte[] k1 = TlsTree.deriveKey(ZERO_KEY, 0x0800000000000000L, cs.getC1(), cs.getC2(), cs.getC3(), cs.getKeyLen());
    ...
    void testDeriveKeyDifferentStartKeys() {
        ...
        assertFalse(Arrays.equals(
                TlsTree.deriveKey(ZERO_KEY, 0, cs.getC1(), cs.getC2(), cs.getC3(), cs.getKeyLen()),
                TlsTree.deriveKey(sk2, 0, cs.getC1(), cs.getC2(), cs.getC3(), cs.getKeyLen())));
    }
    ...
    void testLvsS() {
        ...
        long seqNum = 1L << 32;
        byte[] keyL = TlsTree.deriveKey(ZERO_KEY, seqNum, csL.getC1(), csL.getC2(), csL.getC3(), csL.getKeyLen());
        byte[] keyS = TlsTree.deriveKey(ZERO_KEY, seqNum, csS.getC1(), csS.getC2(), csS.getC3(), csS.getKeyLen());
    ...
    void testDifferentC1MaskProducesDifferentKey() {
        TlsCiphersuite cs = csL();
        long c1 = cs.getC1(); // 0xf800000000000000
        // 0x0000_0000_0000_0000 (C1 mask = 0) vs 0x0800_0000_0000_0000 (C1 mask = 0x0800_0000_0000_0000)
        long seqA = 0L;
    ...
    void testDeriveKeyLengthS() {
        byte[] key = TlsTree.deriveKey(ZERO_KEY, 5, csS().getC1(), csS().getC2(), csS().getC3(), csS().getKeyLen());
        assertEquals(32, key.length);
    }
}
