...
public class Cmac implements Mac {
    ...
    private static byte[] lookupPoly(int blockSizeBytes) {
        ...
        switch (blockSizeBytes * 8) {
            case   64: p = POLY_64;   break;
            case  128: p = POLY_128;  break;
            case  160: p = POLY_160;  break;
            case  192: p = POLY_192;  break;
            case  224: p = POLY_224;  break;
            case  256: p = POLY_256;  break;
            case  320: p = POLY_320;  break;
            case  384: p = POLY_384;  break;
            case  448: p = POLY_448;  break;
            case  512: p = POLY_512;  break;
            case  768: p = POLY_768;  break;
            case 1024: p = POLY_1024; break;
            case 2048: p = POLY_2048; break;
            default:
                throw new IllegalArgumentException(
